...
<h1><liferay-ui:message key="contenido.edita" /></h1>
...
<form:form name="contenidoForm" commandName="contenido" method="post" action="${actionUrl}" >
    ...
    <fieldset>
        ...
        <div>
            <button type="submit" name="<portlet:namespace />_crea" class="btn btn-primary btn-large" id="<portlet:namespace />_crea" ><i class="icon-ok icon-white"></i>&nbsp;<liferay-ui:message key='contenido.actualiza' /></button>
