...
<h1><s:message code="respuesta.nuevo" /></h1>
...
<form:form name="respuestaForm" commandName="respuesta" method="post" action="${actionUrl}" >
    <fieldset>
        ...
        <div>
            <button type="submit" name="<portlet:namespace />_crea" class="btn btn-primary btn-large" id="<portlet:namespace />_crea" ><i class="icon-ok icon-white"></i>&nbsp;<s:message code='respuesta.crea' /></button>
